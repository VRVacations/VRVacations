 ...
 */
module.exports.Component = registerComponent('wasd-rotation', {
  schema: {
  ...
  tick: function (time, delta) {
    ...
    rotation.x = currentrotation.x + movementVector.x;
    rotation.y = currentrotation.y + movementVector.y;
    rotation.z = currentrotation.z + movementVector.z;
